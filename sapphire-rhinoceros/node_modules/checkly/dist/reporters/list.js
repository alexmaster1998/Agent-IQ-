...
class ListReporter extends abstract_list_1.default {
    ...
    onCheckEnd(checkRunId, checkResult, links) {
        ...
        if (links) {
            (0, util_1.printLn)(indentString('View result: ' + chalk.underline.cyan(`${links.testResultLink}`), 4));
            if ((_a = links.testTraceLinks) === null || _a === void 0 ? void 0 : _a.length) {
                // TODO: print all video files URLs
                (0, util_1.printLn)(indentString('View trace : ' + chalk.underline.cyan(links.testTraceLinks.join(', ')), 4));
            }
            if ((_b = links.videoLinks) === null || _b === void 0 ? void 0 : _b.length) {
                // TODO: print all trace files URLs
                (0, util_1.printLn)(indentString('View video : ' + chalk.underline.cyan(`${links.videoLinks.join(', ')}`), 4));
            }
            (0, util_1.printLn)('');
        }
        this._printSummary();
